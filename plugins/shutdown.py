...
execute = [(2, 'quit', bot_exit, 2, L('Shutting down the bot. You can set reason.')),
	 (2, 'restart', bot_restart, 2, L('Restart the bot. You can set reason.')),
	 (2, 'update', bot_update, 2, L('Autoupdate from SVN. You can set reason.'))]
