...
iq_disco_enable = True				# Разрешение отвечать на запрос обзора сервисов
iq_ping_enable = True				# Разрешение отвечать на запрос пинга
...
muc_filter_match_warning_match = 3			# превышение количества одинаковых слов
...
watch_activity_timeout = 1800				# таймаут неактивности конференции для перезахода

muc_filter_rejoin_count = 3					# количество переподлкючений для мониторинга
muc_filter_rejoin_timeout = 120				# промежуток времени на muc_filter_rejoin_count переподключения
muc_filter_status_count = 3					# количество статус-презенсов
muc_filter_status_timeout = 600				# таймаут на статусы muc_filter_status_count
muc_filter_large_status_size = 50			# максимальный размер статус-сообщения
muc_filter_large_nick_size = 20				# максимальный размер ника